# VibeStation: The Ultimate iPad + External Keyboard Setup Guide

This guide ensures your iPad Pro / iPad Air with external keyboard (Magic Keyboard, Logitech Combo Touch, or Bluetooth keyboard) works with **zero friction, zero latency, and desktop-grade keybindings**.
...
1. Open Safari on your iPad and navigate to your VibeStation port `3000` URL (or your Codespaces link).
2. Tap the **Share** button (the square with an arrow pointing up) in Safari.
3. Scroll down and tap **"Add to Home Screen"**.
4. Name it **VibeStation** and tap **Add**.
...
4. Change **Caps Lock** to **Escape** (or **Control**).
   - Now, hitting `Caps Lock` triggers instant `Esc` across VS Code, Vim, and terminal prompts!

---

## 3. Sub-2s Background Reconnection
...
* **The Solution:** 
  ...
  - The moment you unlock your iPad or switch back, VibeStation performs an ultra-fast simulated handshake in **under 1.5 seconds**.
...
| Shortcut | Action |
| :--- | :--- |
| `Cmd + 1` | **Split View** (Code Editor on Left, Live Game on Right) |
| `Cmd + 2` | **Full Code Editor** |
| `Cmd + 3` | **Playtest View** (Geometry Dash full-screen) |
| `Cmd + 4` | **Cloud Terminal** (tmux shell) |
